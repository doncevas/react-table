...
enum ActionTypes {
  ...
  UPDATE_PRODUCT_ACTION = 'app/Products/UPDATE_PRODUCT_ACTION',
  UPDATE_PRODUCT_ACTION_SUCCESS = 'app/Products/UPDATE_PRODUCT_ACTION_SUCCESS',
  UPDATE_PRODUCT_ACTION_FAILED = 'app/Products/UPDATE_PRODUCT_ACTION_FAILED',
